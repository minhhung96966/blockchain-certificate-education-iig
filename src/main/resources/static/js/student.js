...
$(function(){
    ...
    function caculateBase64StringFile(arrayBuffer, callback) {
    ...
    $(document).delegate('#file', 'change', function() {
        ...
        fileReader.onload = function (e) {
            ...
            caculateBase64StringFile(arrayBuffer, function(base64String) {
                $("#file_hash").val(base64String);
                $("#file_hash_show").html("");
            });
        };
                ...
                $.each(result.rows,
                    function(i, item) {
                        ...
                        var editstr = "<td><button type='button' class='btn btn-info view' " +
                            ...
                            "onclick='getCertificate(\"" + item.id + "\")'" + isdisabled + ">Edit</button></td>";
